...
//        private Dictionary<int, InputFunction> buttonFunctions = new Dictionary<int, InputFunction>();
...
//        public void Bind(string buttonName, int buttonId, InputFunction buttonFunction)
//        {
...
//        /// <returns></returns>
//        public InputFunction GetFunctionFromButton(string buttonName, int buttonId)
//        {
//            if (buttonName != "" && buttonName != null)
//            {
//                buttonId = this.GetButtonId(buttonName);
