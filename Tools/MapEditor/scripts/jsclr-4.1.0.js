...
var System$Type=
{
    ...
    definition:
    {
        ...
        {
            if(name == null)
                throw new System.ArgumentNullException.ctor$$String("name");
        ...
        VerifyProperties:function()
        {
            if(!this.allPropertiesVerified)
            {
                ...
                if(baseType != null)
                {
                    ...
                    for(var $i10=0,$l10=props.length,pe=props[$i10];$i10 < $l10;$i10++,pe = props[$i10])
                    {
        ...
        VerifyMethods:function()
        {
            if(this._MethodsByName == null)
            {
                ...
                if(baseType != null)
                {
                    ...
                    for(var $i11=0,$l11=methods.length,pe=methods[$i11];$i11 < $l11;$i11++,pe = methods[$i11])
                    {
        ...
        GetAttributeTarget:function(memberType,memberName)
        {
            ...
            else if(memberType == "method")
            {
                ...
                for(var $i12=0,$l12=methods.length,method=methods[$i12];$i12 < $l12;$i12++,method = methods[$i12])
                {
...
var SharpKit$JavaScript$JsNamingHelper=
{
    ...
    staticDefinition:
    {
        ...
        {
            for(var $i14=0,$l14=prms.length,prm=prms[$i14];$i14 < $l14;$i14++,prm = prms[$i14])
            {
                sb.Append$$String("$$");
