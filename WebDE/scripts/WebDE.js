...
var WebDE$Debug=
{
    ...
    staticDefinition:
    {
        ...
        {
            var debugClock=new WebDE.GUI.GUIFunction.ctor("DebugClock",WebDE.InputManager.InputDevice.Keyboard,"Plus");
            WebDE.InputManager.InputDevice.Keyboard.Bind("NumPlus",107,debugClock);
            WebDE.Debug.Render();
...
var WebDE$DefaultClient=
{
    fullname:"WebDE.DefaultClient",
    baseTypeName:"System.Object",
    staticDefinition:
    {
        cctor:function()
        {
            WebDE.DefaultClient.mainBase = null;
        },
        Initialize:function()
        {
            new WebDE.DefaultClient.ctor();
            WebDE.Game.Init();
        ...
        GetContext:function()
        {
            return WebDE.DefaultClient.mainBase;
        },
    ...
    definition:
    {
        ...
        {
            System.Object.ctor.call(this);
            WebDE.DefaultClient.mainBase = this;
        }
    }
};
JsTypes.push(WebDE$DefaultClient);
if(typeof(JsTypes) == "undefined")
    JsTypes = [];
...
var WebDE$GameObjects$Tile=
{
    ...
    staticDefinition:
    {
        ...
        {
            var newTile=null;
            var $it41=WebDE.GameObjects.Tile.loadedTiles.GetEnumerator();
            while($it41.MoveNext())
            {
        ...
        {
            var $it42=WebDE.GameObjects.Tile.loadedTiles.GetEnumerator();
            while($it42.MoveNext())
            {
                var tile=$it42.get_Current();
                if(tile.GetName() == tileName)
                {
    ...
    definition:
    {
        ...
        CalculateLightLevel:function()
        {
            ...
            var $it43=localLights.GetEnumerator();
            while($it43.MoveNext())
            {
                var currentLight=$it43.get_Current();
            ...
            var $it44=reds.GetEnumerator();
            while($it44.MoveNext())
            {
                var curRed=$it44.get_Current();
                avgRed += curRed;
            }
            var $it45=blues.GetEnumerator();
            while($it45.MoveNext())
            {
                var curBlue=$it45.get_Current();
                avgBlue += curBlue;
            }
            var $it46=greens.GetEnumerator();
            while($it46.MoveNext())
            {
                var curGreen=$it46.get_Current();
                avgGreen += curGreen;
            }
        ...
        old_CalculateLightLevel:function()
        {
            this.SetLightLevel(WebDE.Color.Black);
            var localLights=WebDE.GameObjects.LightSource.GetLocalLightSources(this.GetPosition().x,this.GetPosition().y);
            var $it47=localLights.GetEnumerator();
            while($it47.MoveNext())
            {
                var currentLight=$it47.get_Current();
                var dist=this.GetPosition().Distance(currentLight.GetPosition());
                var diminishAmount=dist * 0.1;
...
var WebDE$GUI$GuiElement=
{
    ...
    definition:
    {
        ...
        GetSize:function()
        {
            return WebDE.GameObjects.Stage.CurrentStage.GetTileSize();
        },
        SetNeedsUpdate:function()
        {
...
var WebDE$GUI$GuiLayer=
{
    ...
    definition:
    {
        ...
        DoGUIFunction:function(func)
        {
            ...
            {
                var thisPixelPos=new WebDE.Point.ctor(this.GetPosition().x * WebDE.GameObjects.Stage.CurrentStage.GetTileSize().get_Item1(),this.GetPosition().y * WebDE.GameObjects.Stage.CurrentStage.GetTileSize().get_Item2());
...
var WebDE$Timekeeper$Clock=
{
    ...
    staticDefinition:
    {
        cctor:function()
        {
            ...
            WebDE.Timekeeper.Clock.calculationList = new System.Collections.Generic.Dictionary$2.ctor(System.String,WebDE.Timekeeper.Execution);
            WebDE.Timekeeper.Clock.renderList = new System.Collections.Generic.Dictionary$2.ctor(System.String,WebDE.Timekeeper.Execution);
            WebDE.Timekeeper.Clock.intervals = new System.Collections.Generic.Dictionary$2.ctor(System.String,WebDE.Timekeeper.TimedExecution);
            WebDE.Timekeeper.Clock.timeouts = new System.Collections.Generic.Dictionary$2.ctor(System.String,WebDE.Timekeeper.TimedExecution);
        },
        Start:function()
        {
        ...
        loop:function()
        {
            ...
            {
                window.setTimeout(WebDE.Timekeeper.Clock.loop,Cast(frameInterval,System.Int32) - frameTime);
            }
        },
