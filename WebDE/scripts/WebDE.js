...
var WebDE$Rendering$DOM_Renderer=
{
    ...
    definition:
    {
        ...
        RenderGUILayer:function(glayer)
        {
            ...
            {
                glayer.SetPosition(WebDE.InputManager.InputDevice.Mouse.GetAxisPosition(0) - (glayer.GetSize().get_Item1() / 2),WebDE.InputManager.InputDevice.Mouse.GetAxisPosition(1) - (glayer.GetSize().get_Item2() / 2));
        ...
        RenderGUIElement:function(gelm)
        {
            ...
            if(gentlement == null)
            {
                ...
                {
                    gentlement.style.width = gelm.GetSize().get_Item1() + " px";
                    gentlement.style.height = gelm.GetSize().get_Item2() + "px";
                }
                var styleString="";
