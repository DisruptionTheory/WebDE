...
namespace WebDE.Rendering
{
    ...
    public class Gradient
    {
        ...
        */
        ...
        {
            return "background: url(data:image/svg+xml;base64,); " +
                "background: -moz-radial-gradient(center, ellipse cover,  rgba(0,80,200,0.25) 15%, rgba(0,80,200,0.34) 26%, rgba(0,80,200,0.6) 59%, rgba(0,80,200,0.65) 66%, rgba(0,80,200,0) 85%, rgba(0,80,200,0) 100%); " +
                "background: -webkit-gradient(radial, center center, 0px, center center, 100%, color-stop(15%,rgba(0,80,200,0.25)), color-stop(26%,rgba(0,80,200,0.34)), color-stop(59%,rgba(0,80,200,0.6)), color-stop(66%,rgba(0,80,200,0.65)), color-stop(85%,rgba(0,80,200,0)), color-stop(100%,rgba(0,80,200,0))); " +
                "background: -webkit-radial-gradient(center, ellipse cover,  rgba(0,80,200,0.25) 15%,rgba(0,80,200,0.34) 26%,rgba(0,80,200,0.6) 59%,rgba(0,80,200,0.65) 66%,rgba(0,80,200,0) 85%,rgba(0,80,200,0) 100%); " +
                "background: -o-radial-gradient(center, ellipse cover,  rgba(0,80,200,0.25) 15%,rgba(0,80,200,0.34) 26%,rgba(0,80,200,0.6) 59%,rgba(0,80,200,0.65) 66%,rgba(0,80,200,0) 85%,rgba(0,80,200,0) 100%); " +
                "background: -ms-radial-gradient(center, ellipse cover,  rgba(0,80,200,0.25) 15%,rgba(0,80,200,0.34) 26%,rgba(0,80,200,0.6) 59%,rgba(0,80,200,0.65) 66%,rgba(0,80,200,0) 85%,rgba(0,80,200,0) 100%); " +
                "background: radial-gradient(ellipse at center,  rgba(0,80,200,0.25) 15%,rgba(0,80,200,0.34) 26%,rgba(0,80,200,0.6) 59%,rgba(0,80,200,0.65) 66%,rgba(0,80,200,0) 85%,rgba(0,80,200,0) 100%); " +
